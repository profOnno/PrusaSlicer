...
static std::vector<std::string> s_Preset_print_options {
    ...
    "seam_position","staggered_inner_seams", "external_perimeters_first", "fill_density", "fill_multiline", "fill_pattern", "top_fill_pattern",
    "bottom_fill_pattern", "infill_every_layers", /*"infill_only_where_needed",*/ "solid_infill_every_layers", "fill_angle", "bridge_angle",
